...
export default class Carousel extends Component {
	...
	this._onScrollBeginDrag = this._snapEnabled ? this._onScrollBeginDrag.bind(this) : ()=>{};
        this._onScrollEnd = this._snapEnabled || props.autoplay ? this._onScrollEnd.bind(this) : ()=>{};
        this._onScrollEndDrag = !props.enableMomentum ? this._onScrollEndDrag.bind(this) : ()=>{};
        this._onMomentumScrollEnd = props.enableMomentum ? this._onMomentumScrollEnd.bind(this) : ()=>{};
    ...
    render () {
        ...
        return (
            <ScrollView
			  ...
			  scrollEnabled={this.props.enableSnap}
            >
                { this._childSlides() }
            </ScrollView>
        );
